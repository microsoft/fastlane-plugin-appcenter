...
- `APPCENTER_DISTRIBUTE_MAPPING` - Path to your Android mapping.txt file 
- `APPCENTER_DISTRIBUTE_UPLOAD_MAPPING_ONLY` - Flag to upload only the mapping file to App Center
