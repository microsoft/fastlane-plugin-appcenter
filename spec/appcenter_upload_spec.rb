...
def stub_set_metadata(status, file_name = "apk_file_empty.apk")
  stub_request(:post, "https://upload-domain.com/upload/set_metadata/1234?content_type=&file_name=#{file_name}&file_size=0&token=123abc")
...
def stub_poll_for_release_id(status)
  stub_request(:get, "https://api.appcenter.ms/v0.1/apps/owner/app/uploads/releases/upload_id")
